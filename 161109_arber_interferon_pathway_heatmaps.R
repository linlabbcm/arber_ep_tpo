...
enriched_interferon_genes = read.delim('/grail/projects/arber2/tables/enriched_interferon.txt', header = TRUE, sep = '\t')


enriched_rows = c()
for(gene in enriched_interferon_genes[,1]){
...
png(filename = '/grail/projects/arber2/figures/enriched_interferon_genes_heatmap_median_norm.png',width = 800,height =800)
...
write.table(rownames(medianMatrix[expOrder,]), file = "/grail/projects/arber2/tables/enriched_interferon_genes_heatmap_order.txt", append = FALSE, quote = FALSE, sep = "\t", eol = '\n', na = "NA", dec = '.', row.names = FALSE, col.names = FALSE,
